...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      >
        ...
        <div className="relative z-10 px-12 xl:px-16 pb-14 pt-14 w-full">
          <div className="flex items-center gap-3 mb-20">
            <div className="flex items-center justify-center rounded-xl w-10 h-10 bg-gradient-brand">
              <svg
                width="20"
                height="20"
                viewBox="0 0 24 24"
      ...
      {/* Right form panel */}
      <div className="flex-1 flex items-center justify-center px-6 sm:px-12 bg-white dark:bg-gray-900">
        <div className="w-full max-w-[360px]">
          <div className="lg:hidden flex items-center gap-2.5 mb-12">
            <div className="flex items-center justify-center rounded-lg w-9 h-9 bg-gradient-brand">
              <svg
                width="18"
                height="18"
                viewBox="0 0 24 24"
          ...
          <h2
            className="text-2xl text-gray-900 dark:text-gray-100 tracking-tight"
            style={{ fontWeight: 700 }}
          >
            登录
          </h2>
          <p className="text-gray-500 dark:text-gray-400 text-sm mt-1.5 mb-8">请输入您的账户信息</p>

          {error && (
            <div className="mb-6 px-4 py-3 rounded-lg bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-sm text-red-600 dark:text-red-400 flex items-center gap-2.5">
              <svg
                width="16"
                height="16"
                viewBox="0 0 24 24"
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              ...
              className="w-full rounded-lg px-4 py-2.5 text-sm font-semibold text-white bg-gradient-brand focus:outline-none focus:ring-2 focus:ring-blue-500/40 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition hover:brightness-110"
            >
              {loading ? (
